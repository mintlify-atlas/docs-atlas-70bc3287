...
Create the file `~/.config/nvim/queries/markdown/textobjects.scm`:
...
Create the file `~/.config/nvim/queries/markdown_inline/textobjects.scm`:
...
Create the file `~/.config/nvim/queries/css/textobjects.scm`:
...
Create the file `~/.config/nvim/queries/bash/textobjects.scm` (or `zsh/textobjects.scm` for Zsh):
