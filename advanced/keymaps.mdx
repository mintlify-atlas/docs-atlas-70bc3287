...
The default mappings also include `iI` as an alias for `ii` (inner-inner), matching the behaviour of [vim-indent-object](https://github.com/michaeljsmith/vim-indent-object).
